            ...
            <fieldset disabled={connected}>
              <label>
                ...
                <textarea
                  ...
                  rows={20}
                  style={{ minHeight: '400px', fontSize: '13px', lineHeight: '1.5' }}
              ...
              <label>
                ...
                <input
                  ...
                  value={model}
                  disabled
                  style={{ backgroundColor: 'var(--Neutral-10)', color: 'var(--Neutral-60)' }}
                />
                <small style={{ color: 'var(--Neutral-60)', fontSize: '12px', marginTop: '4px', display: 'block' }}>
